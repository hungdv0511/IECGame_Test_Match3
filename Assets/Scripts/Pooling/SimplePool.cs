...
public static class SimplePool
{
	...
	class Pool
	{
		...
		public void DespawnWithDelay(MonoBehaviour mono, GameObject obj, float delay)
		{
			mono.StartCoroutine(IEDespawn(obj, delay));
		}
		IEnumerator IEDespawn(GameObject obj, float delay)
		{
	...
	/// </summary>
	static public void Despawn(GameObject obj, bool resetParent = true, float delayTime = 0)
	{
		...
		else
		{
			...
			if (delayTime == 0)
				...
				pm.myPool.DespawnWithDelay(pm, obj, delayTime);

		}
	}

	internal static void Spawn(TextMeshPro text_ingame)
	{
